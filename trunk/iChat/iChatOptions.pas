...
type
  TfrmiChatOptions = class(TForm)
    PageControl1: TPageControl;
    tsiChatMain: TTabSheet;
  ...
  TiChatConf = class(TConf)
  public
    ChatClient: TChatClient;
    frmiChatOptions: TfrmiChatOptions;
    FToolButtons: TiChatToolButtons;
...
begin
  ...
  RootNode.Name:='iChat_Options';
  RootNode.FullName:='Intranet Chat';
  ...
  ConfItems.Add('ServerPort', 'Server port number', '6666', 'S');
  ...
  ConfItems.Add('ClientVersion', 'Client version', 'Intranet Chat client for RealChat ver. 0.1', 'S');
  ...
  frmIChatOptions:=TfrmIChatOptions.Create(Core.MainForm);
  frmIChatOptions.ChatClient:=ChatClient;
  frmIChatOptions.FillConfigNodes(RootNode);
  ...
  TB.OnClick:=frmiChatOptions.ToolButtonClick;
...
// Connection page
//======================================
procedure TfrmiChatOptions.SetNewNick(Sender :TObject);
begin
...
procedure TfrmiChatOptions.SetNewServer(Sender: TObject);
var
	i : integer;
  n : string;
begin
...
procedure TfrmiChatOptions.AddNickClick(Sender: TObject);
var
	i: integer;
begin
...
procedure TfrmiChatOptions.DelNickClick(Sender: TObject);
var
	i: integer;
begin
...
procedure TfrmiChatOptions.AddServerClick(Sender: TObject);
var
	i: integer;
begin
...
procedure TfrmiChatOptions.DelServerClick(Sender: TObject);
var
	i: integer;
begin
...
procedure TfrmiChatOptions.vleSoundsEditButtonClick(Sender: TObject);
var
 fsd: TOpenDialog;
 curKey: string;
begin
...
procedure TfrmiChatOptions.btnSoundTestClick(Sender: TObject);
begin
...
// Options items list
//======================================
procedure TfrmiChatOptions.FillConfigNodes(RootNode: TConfNode);
var
  NewNode: TConfNode;
  NewNode2: TConfNode;
begin
...
procedure TfrmiChatOptions.RefreshSettings(ConfNode: TConfNode);
var
  conf: TConfItems;
  i: integer;
begin
...
procedure TfrmiChatOptions.ApplySettings(ConfNode: TConfNode);
var
  conf: TConfItems;
  i: integer;
...
procedure TfrmiChatOptions.OnApplySettingsHandler(Sender: TObject);
begin
  ApplySettings(TConfNode(Sender));
end;

procedure TfrmiChatOptions.OnRefreshSettingsHandler(Sender: TObject);
begin
  RefreshSettings(TConfNode(Sender));
end;

procedure TfrmiChatOptions.ToolButtonClick(Sender: TObject);
var
  TB: TToolButton;
begin
...
procedure TfrmiChatOptions.ChangeLanguage();
var
  RootNode: TConfNode;
